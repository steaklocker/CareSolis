...
import RTMEnrollmentConfirmation from './pages/RTMEnrollmentConfirmation';
import RefillsMonitorPage from './pages/RefillsMonitorPage';
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "visits/past", element: <PastVisits /> },
      { path: "visits/active", element: <ActiveVisit /> },
      { path: "visits/complete", element: <VisitComplete /> },
      ...
      // Signup disabled - admin-controlled access only
      ...
      { path: "rtm-enrollment-confirmation", element: <RTMEnrollmentConfirmation /> },
