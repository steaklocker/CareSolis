...
import { Home, Pill, MessageCircle, Activity, MoreHorizontal, LayoutDashboard, User, Clock } from 'lucide-react';
...
export function BottomNav() {
  ...
  // 3. Visits - Scheduled patient visits and EVV tracking
  // 4. Messages - Alerts + care team communication hub
  // 5. Activity - Recent history and trends
  // 6. More - Settings, manuals, secondary features
  const caregiverTabs = [
    { to: '/', label: 'Home', icon: Home, end: true },
    { to: '/medications', label: 'Meds', icon: Pill, end: false },
    { to: '/visits', label: 'Visits', icon: Clock, end: false },
