...
export function Sidebar({ isOpen = false, onClose }: SidebarProps) {
  ...
  > = [
    ...
    { to: '/visits', label: 'EVV & Visit Tracking', icon: Clock, allowedRoles: ['admin'] },
    ...
    { to: '/user-management', label: 'User Management', icon: Users, allowedRoles: ['admin'] },
    { to: '/permission-matrix', label: 'Permission Matrix', icon: ShieldCheck, allowedRoles: ['admin'] },
