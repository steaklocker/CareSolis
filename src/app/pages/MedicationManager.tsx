  ...
  return (
    <div className="p-3 sm:p-4 md:p-6 space-y-4 sm:space-y-6">
      ...
      {pendingMedication && detectedConflicts.length > 0 && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[100] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
