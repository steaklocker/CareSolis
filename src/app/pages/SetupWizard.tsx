...
import {
  ...
  AlertTriangle, Pill, Settings, FileCheck, Smartphone, Eye, Loader2, Package, Heart
} from 'lucide-react';
...
import { PouchCapacityStep, type MedicationEntry } from '../components/PouchCapacityStep';
...
export default function SetupWizard() {
  ...
  const steps: Array<{ id: SetupStep; title: string; icon: React.ElementType }> = [
    ...
    { id: 'medical-history', title: 'Medical History', icon: Heart },
    ...
    { id: 'pouch-capacity', title: 'Pouch Capacity', icon: Package },
      ...
      <div className="max-w-4xl mx-auto px-8 py-12">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {/* STEP 4: MEDICAL HISTORY & COMORBIDITIES */}
            {currentStep === 'medical-history' && (
              <div className="bg-slate-900 rounded-2xl shadow-lg p-8 border border-slate-700">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h2 className="text-3xl font-bold text-slate-50">Medical History</h2>
                    <p className="text-slate-400">Chronic conditions, allergies, and current medications</p>
                  </div>
                </div>

                <div className="bg-blue-500/10 border-l-4 border-blue-500 rounded-lg p-4 mb-6">
                  <p className="text-sm text-blue-300">
                    <strong>Why we collect this:</strong> Medical history helps Care Circle members and healthcare providers understand the patient's health context. This information is critical for medication adherence monitoring and emergency situations.
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mb-2">Add each condition separately (e.g., Type 2 Diabetes, Hypertension, COPD)</p>
                    <div className="space-y-2">
                        ...
                        <div key={idx} className="flex gap-2">
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              setMedicalHistory({...medicalHistory, conditions: updated});
                            }}
                            placeholder="e.g., Type 2 Diabetes"
                            className="flex-1 px-4 py-3 bg-slate-800 border-2 border-slate-700 rounded-lg text-slate-100 placeholder-slate-500 focus:border-rose-500 focus:ring-2 focus:ring-rose-500/20 outline-none transition-all"
                          />
                          <button
                            onClick={() => {
                              const updated = medicalHistory.conditions.filter((_, i) => i !== idx);
                              setMedicalHistory({...medicalHistory, conditions: updated});
                            }}
                            className="px-4 py-2 bg-slate-800 border-2 border-slate-700 text-slate-400 rounded-lg hover:bg-rose-500/20 hover:border-rose-500 hover:text-rose-400 transition-all"
                          >
                            Remove
                          </button>
                        </div>
                      ...
                      <button
                        onClick={() => setMedicalHistory({...medicalHistory, conditions: [...medicalHistory.conditions, '']})}
                        className="w-full px-4 py-3 bg-slate-800 border-2 border-dashed border-slate-700 text-slate-400 rounded-lg hover:border-rose-500 hover:text-rose-400 transition-all"
                      >
                        + Add Condition
                      </button>
                    </div>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mb-2">Add each allergy separately (e.g., Penicillin, Sulfa drugs)</p>
                    <div className="space-y-2">
                      {medicalHistory.allergies.map((allergy, idx) => (
                        <div key={idx} className="flex gap-2">
                          ...
                          <button
                            onClick={() => {
                              const updated = medicalHistory.allergies.filter((_, i) => i !== idx);
                              setMedicalHistory({...medicalHistory, allergies: updated});
                            }}
                            className="px-4 py-2 bg-slate-800 border-2 border-slate-700 text-slate-400 rounded-lg hover:bg-rose-500/20 hover:border-rose-500 hover:text-rose-400 transition-all"
                          >
                      ...
                      <button
                        onClick={() => setMedicalHistory({...medicalHistory, allergies: [...medicalHistory.allergies, '']})}
                        className="w-full px-4 py-3 bg-slate-800 border-2 border-dashed border-slate-700 text-slate-400 rounded-lg hover:border-rose-500 hover:text-rose-400 transition-all"
                      >
                        + Add Allergy
                      </button>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mb-2">Add each medication with dosage (e.g., Metformin 500mg)</p>
                    <div className="space-y-2">
                        ...
                        <div key={idx} className="flex gap-2">
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              updated[idx] = e.target.value;
                              setMedicalHistory({...medicalHistory, medications: updated});
                            }}
                          ...
                          <button
                            onClick={() => {
                              const updated = medicalHistory.medications.filter((_, i) => i !== idx);
                              setMedicalHistory({...medicalHistory, medications: updated});
                            }}
                            className="px-4 py-2 bg-slate-800 border-2 border-slate-700 text-slate-400 rounded-lg hover:bg-rose-500/20 hover:border-rose-500 hover:text-rose-400 transition-all"
                          >
                      ...
                      <button
                        onClick={() => setMedicalHistory({...medicalHistory, medications: [...medicalHistory.medications, '']})}
                        className="w-full px-4 py-3 bg-slate-800 border-2 border-dashed border-slate-700 text-slate-400 rounded-lg hover:border-rose-500 hover:text-rose-400 transition-all"
                      >
                        + Add Medication
                      </button>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={medicalHistory.primaryPhysician}
                        onChange={(e) => setMedicalHistory({...medicalHistory, primaryPhysician: e.target.value})}
                        placeholder="e.g., Dr. Sarah Chen, MD"
                        className="w-full px-4 py-3 bg-slate-800 border-2 border-slate-700 rounded-lg text-slate-100 placeholder-slate-500 focus:border-rose-500 focus:ring-2 focus:ring-rose-500/20 outline-none transition-all"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setMedicalHistory({...medicalHistory, physicianPhone: e.target.value})}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="e.g., Michael Whitmore (Son)"
                        className="w-full px-4 py-3 bg-slate-800 border-2 border-slate-700 rounded-lg text-slate-100 placeholder-slate-500 focus:border-rose-500 focus:ring-2 focus:ring-rose-500/20 outline-none transition-all"
                      />
                    </div>
                ...
                <div className="mt-6 p-4 bg-amber-500/10 rounded-lg border-l-4 border-amber-500">
                  <p className="text-sm text-amber-300">
                    <strong>Optional but Recommended:</strong> Providing complete medical history enables better care coordination and faster emergency response.
                  </p>
                </div>
              </div>
            )}
            ...
            {/* STEP 7: POUCH CAPACITY */}
            {currentStep === 'pouch-capacity' && (
              <PouchCapacityStep
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-6 bg-slate-800 rounded-xl border-2 border-slate-700">
                    ...
                    <div className="space-y-4 text-sm">
                      {medicalHistory.conditions.filter(c => c).length > 0 && (
                        <div>
                          <div className="text-slate-400 font-semibold mb-2">Chronic Conditions / Comorbidities</div>
                          <div className="flex flex-wrap gap-2">
                            {medicalHistory.conditions.filter(c => c).map((condition, idx) => (
                              <span key={idx} className="px-3 py-1 bg-rose-500/20 text-rose-300 rounded-full text-xs">
                                {condition}
                              </span>
                            ))}
                          </div>
                      ...
                      {medicalHistory.allergies.filter(a => a).length > 0 && (
                        <div>
                          <div className="text-slate-400 font-semibold mb-2">Known Allergies</div>
                          <div className="flex flex-wrap gap-2">
                            {medicalHistory.allergies.filter(a => a).map((allergy, idx) => (
                      ...
                      {medicalHistory.medications.filter(m => m).length > 0 && (
                        <div>
                          <div className="text-slate-400 font-semibold mb-2">Current Medications</div>
                          <div className="flex flex-wrap gap-2">
                            {medicalHistory.medications.filter(m => m).map((medication, idx) => (
                      ...
                      <div className="grid md:grid-cols-2 gap-4 pt-2 border-t border-slate-700">
                        {medicalHistory.primaryPhysician && (
                          <div>
                            <div className="text-slate-400">Primary Physician</div>
                            <div className="font-semibold text-slate-100">{medicalHistory.primaryPhysician}</div>
                            {medicalHistory.physicianPhone && (
                              <div className="text-slate-400 text-xs mt-1">{medicalHistory.physicianPhone}</div>
                            )}
                          </div>
                        )}
                        {medicalHistory.emergencyContact && (
                          <div>
                            ...
                            <div className="font-semibold text-slate-100">{medicalHistory.emergencyContact}</div>
                            {medicalHistory.emergencyPhone && (
                              <div className="text-slate-400 text-xs mt-1">{medicalHistory.emergencyPhone}</div>
                            )}
                          </div>
                        )}
                      </div>
                      {medicalHistory.conditions.filter(c => c).length === 0 &&
                       medicalHistory.allergies.filter(a => a).length === 0 &&
                       medicalHistory.medications.filter(m => m).length === 0 && (
                        <div className="text-slate-400 italic">No medical history provided</div>
                      )}
                    </div>
                  </div>
                  ...
                  {/* Pouch Capacity Summary */}
                  {medications.length > 0 && (
                    <div className="p-6 bg-purple-500/10 rounded-xl border-2 border-purple-500/30">
                      <h3 className="font-bold text-purple-300 mb-3 flex items-center gap-2">
                        <Package size={20} />
                        Pouch Capacity ({medications.length} medication{medications.length !== 1 ? 's' : ''})
                      </h3>
                      <div className="space-y-2 text-sm">
                        {medications.map((m, i) => (
                          <div key={m.id} className="flex items-center gap-2 text-slate-300">
                            <span className="w-5 h-5 rounded-full bg-purple-600/40 text-purple-300 text-xs flex items-center justify-center font-bold">{i + 1}</span>
                            <span className="font-medium">{m.name || '(unnamed)'}</span>
                            {m.strength && <span className="text-slate-400">{m.strength}</span>}
                            <span className="text-slate-500">·</span>
                            <span className="text-slate-400">{m.pillsPerDose} pill{m.pillsPerDose !== 1 ? 's' : ''}/dose</span>
                            <span className="text-slate-500">·</span>
                            <span className="text-xs px-1.5 py-0.5 bg-slate-700 text-slate-300 rounded">{m.sizeClass}</span>
                            <span className="text-slate-500">·</span>
                            <span className="text-slate-400">{m.doseTimes.join(', ') || 'no times'}</span>
                          </div>
                        ))}
                      </div>
                    </div>
